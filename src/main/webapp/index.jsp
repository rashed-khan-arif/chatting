...
<div id="frame">
    <div id="sidepanel">
        <div id="profile">
            <div class="wrap">
                <img id="profile-img" src="img/mikeross.png" class="online" alt=""/>
                <p>Bayzid Islam</p>
                ...
                <div id="expanded">
                    ...
                    <input name="twitter" type="text" value="bayzid_islam"/>
                    <label><i class="fa fa-twitter fa-fw" aria-hidden="true"></i></label>
                    <input name="twitter" type="text" value="bayzid69"/>
                    <label><i class="fa fa-instagram fa-fw" aria-hidden="true"></i></label>
                    <input name="twitter" type="text" value="bayzid.69"/>
                </div>
            </div>
        </div>
        <div id="search">
                ...
                <li class="contact active">
                    <div class="wrap">
                        ...
                        <div class="meta">
                            ...
                            <p class="preview">Thanks you rashed khan arif </p>
                        </div>
                    </div>
                </li>
